...
- Software engineering: Because it taught me [type annotation](https://www.youtube.com/watch?v=gowHu-r-zXg "Crusherfire"), [code organization](https://www.youtube.com/watch?v=waVoVpspazI "TheMyzta"), [debugging](https://www.youtube.com/watch?v=yOmPc2g8tbY "Roblox Learn"), and [version control](https://www.youtube.com/watch?v=IJDg6tRJmHo "Leif").
- Video game development: Because it taught me world building (`workspace`, `Lighting`), [gameplay systems](https://www.youtube.com/@DevBuildStudios/videos "DevBuild"), input handling (`UserInputService`, `ContextActionService`), UI development (`ScreenGui`, `GuiObject`), and [playtesting](https://www.youtube.com/watch?v=XpQaWyaMn_Y "Roblox Studio in a Minute").
